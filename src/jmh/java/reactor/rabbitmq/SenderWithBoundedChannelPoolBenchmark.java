...
@Fork(1)
@Threads(2)
public class SenderWithBoundedChannelPoolBenchmark {
    ...
    public void setupConnection() throws Exception {
        ...
        channelPool = ChannelPoolFactory.createBoundedChannelPool(Mono.just(connection), new ChannelPoolOptions().poolSize(channelPoolSize));
    }
